...
# --- Step 2: Configure Logging and Global Variables ---
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - [DataExtractor] - %(message)s')

DB_CONFIG = {
    'hospital_a': {'user': 'root', 'password': '0509', 'host': '127.0.0.1', 'port': '3306', 'db': 'hospital_a'},
    'hospital_b': {'user': 'root', 'password': '0509', 'host': '127.0.0.1', 'port': '3306', 'db': 'hospital_b'}
}
CLAIMS_FOLDER = './Data/claims' 

# --- Step 3: Define the Data Extractor Class ---
class DataExtractor:
...
# --- Step 4: Define the Main Orchestrator Function ---
def run_extraction():
    """
    ...
    # --- 4b. Standardization & Integration ---
    logging.info("--- Standardizing and integrating all data sources...")
    
    # Standardize the known difference in 'patients' table columns.
...
# --- Step 5: Isolated Test Block ---
if __name__ == "__main__":
    # This block allows us to run ONLY this file for testing purposes.
    # The master pipeline will call run_extraction() directly.
