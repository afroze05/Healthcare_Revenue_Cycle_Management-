...
# --- Step 2: Import the REAL data handoff from our extraction script ---
# This is the crucial connection between the two phases.
from extraction import run_extraction

# --- Step 3: Configure Logging ---
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - [%(filename)s] - %(message)s')

# --- Step 4: Define the Data Transformer Class ---
...
if __name__ == "__main__":
    ...
    try:
        ...
        # --- FINAL OUTPUT ---
        # Display a summary of the final, fully prepared data.
        print("\n\n" + "="*80)
